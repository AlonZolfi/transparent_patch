...
class SplitDataset:
    ...
    def __call__(self, val_split, test_split, shuffle_dataset, random_seed, batch_size, *args, **kwargs):
        ...
        train_loader = DataLoader(self.dataset, batch_size=batch_size, sampler=train_sampler, num_workers=5)
        validation_loader = DataLoader(self.dataset, batch_size=batch_size, sampler=valid_sampler, num_workers=5)
